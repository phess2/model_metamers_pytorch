...
def build_net(ds_kwargs={}, return_metamer_layers=False):
    ...
    ckpt_path = os.path.join(
        MODEL_BASE_PATH, "visual_networks", "pytorch_checkpoints", "swsl_resnet50.pt"
    )

    change_prefix_checkpoint = {
        "model.module.": "model.",
        "attacker.model.module": "attacker.model",
    }
    ...
    model, _ = make_and_restore_model(
        ...
        strict=False,  # normalization values not saved in checkpoint here.
