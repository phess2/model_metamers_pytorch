...
parser = argparse.ArgumentParser(
    description="Input the name of the network for the metamers you want to evalalute"
)
parser.add_argument(
    "MET_NET", metavar="M", type=str, help="Network from which metamers were generated."
)
parser.add_argument(
    "-F",
    "--FOLDER",
    metavar="--F",
    type=str,
    default="network_network_evaluations",
...
layer_order, metamer_list = get_metamer_list_from_network_name(
    args.MET_NET, all_model_info, network_type="image"
)
...
correct_incorrect_16, average_correct_16 = evaluate_predicted_vs_actual(
    prediction_dict["labels_16_way_all_layers"],
    prediction_dict["predictions_16_way_all_layers"],
)

bootstrap_sem_1000, bootstrap_sem_16 = bootstrap_imagenet_correct_incorrect(
    correct_incorrect_1000, correct_incorrect_16, num_bootstraps=1000
)

output_dict = {
    "correct_incorrect_1000": correct_incorrect_1000,
    ...
    "predictions_1000_way_all_layers": prediction_dict[
