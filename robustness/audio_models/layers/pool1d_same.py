...
class AvgPool1dSame(nn.AvgPool1d):
    ...
    def __init__(
        ...
        super(AvgPool1dSame, self).__init__(
            kernel_size, stride, (0), ceil_mode, count_include_pad
        )
...
class MaxPool1dSame(nn.MaxPool1d):
    ...
    def __init__(
        ...
        super(MaxPool1dSame, self).__init__(
            kernel_size, stride, (0), dilation, ceil_mode, count_include_pad
        )

    def forward(self, x):
        return max_pool1d_same(
            x,
            self.kernel_size,
            self.stride,
            self.padding,
