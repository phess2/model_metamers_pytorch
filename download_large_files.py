...
VISUAL_CHECKPOINTS_LOCATION = (
    "model_analysis_folders/visual_networks/pytorch_checkpoints/"
)
AUDIO_CHECKPOINTS_LOCATION = (
    "model_analysis_folders/audio_networks/pytorch_checkpoints/"
)
